...
/*   Updated: 2019/07/04 17:42:16 by jjacobso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_op	g_op_tab[] =
{
	...
	{"and", 3, (int[]){T_REG | T_DIR | T_IND, T_REG | T_IND | T_DIR, T_REG}, 6,
		6, &and, 1, 1},
	{"or", 3, (int[]){T_REG | T_IND | T_DIR, T_REG | T_IND | T_DIR, T_REG}, 7,
		6, &or, 1, 1},
	{"xor", 3, (int[]){T_REG | T_IND | T_DIR, T_REG | T_IND | T_DIR, T_REG}, 8,
		6, &xor, 1, 1},
	...
	{"lldi", 3, (int[]){T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, 14, 50,
		&lldi, 1, 0},
	{"lfork", 1, (int[]){T_DIR}, 15, 1000, &lclone, 0, 0},
